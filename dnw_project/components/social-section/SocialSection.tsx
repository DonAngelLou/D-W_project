...
const testimonialsData: CardProps[] = [
  {
    ...
    commentParagraph1: `Woke up to Deadpool and Wolverine reviews and I haven't seen a single tweet that had any cons about this movie... everyone is praising it like WE'RE SO BACK!!!`,
    time: '9:41 PM',
    date: 'July 26, 2024',
    likesCount: '32',
    repliesCount: '5',
  ...
  },
  {
    ...
    commentParagraph1: `@VancityReynolds, Hey Ryan Just saw Deadpool and the Wolverine yesterday I came back to a movie theater after 4 years, and I love the movie!!! Loved the cameos & I still think that LFG was stolen from the gaffer Phil Parkinson lol lol. Wrexham Fan Here.`,
    time: '9:41 PM',
    date: 'July 29, 2024',
    likesCount: '1',
  },
        ...
        <div className="relative h-[96px] md:h-[152px] lg:h-[176px] w-[320px] md:w-[408px] lg:w-[464px]">
          ...
          <div className="absolute -inset-y-4 md:-inset-y-3 lg:-inset-y-5 inset-x-4 flex justify-end items-end">
            <div
              ...
              style={{
                backgroundImage:
                  "url('/social-fanzone-bg-2.png'), linear-gradient(#BD0D38, #BD0D38)",
              }}
            >
              <span className="font-bebas tracking-wider text-2xl md:text-3xl">
                FAN ZONE
              </span>
            </div>
          </div>
